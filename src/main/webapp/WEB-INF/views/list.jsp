...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>Login page | Movie Information System</title>
  ...
  $(function() {
    ...
    <body>
        <div class="container">
            ...
            <header>
                <h1><a href="/myapp/movie/">Movie Information System</a></h1>
            ...
            <section>				
                <div id="container_demo" >
                    ...
                    <div id="wrapper">
 						...
 						<c:url var="addAction" value="/movie/checkLogin/" ></c:url>
                            <form:form  action="${addAction}" method="post" accept-charset="utf-8" autocomplete="on"> 
                                ...
                                <p class="change_link">
									Not a member yet ?
									<a href="/myapp/movie/register" method="get">Join us</a>
								</p>
                            </form:form>
                        </div>
                    </div>
